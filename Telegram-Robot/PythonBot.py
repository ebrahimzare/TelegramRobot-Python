...
from urllib.parse import quote, unquote     # importing the quote/unquote attributes from the parse
# method in urllib library
...
TOKEN = '882228977:AAHGikaxZq_soFicKbgyZ5BTOSI50U0WBP4'       # define the access token
